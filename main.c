...
const char *svg_paths[] = {
    ...
    "M 530 364 "
    "C 557 364 582 356 600 342 "
    "L 587 320 "
    "C 573 331 553 337 532 337 "
    "C 479 337 444 299 444 250 "
    "C 444 201 479 163 532 163 "
    "C 553 163 573 169 587 180 "
    "L 600 158 "
    "C 582 144 557 136 530 136 "
    "C 463 136 414 186 414 250 "
    "C 414 314 463 364 530 364 "
    "Z "
    /* Inner “G” bar */
    "M 560 250 L 532 250 L 532 300 L 492 300 L 492 240 L 560 240 Z",

    /* 1: "A" – a simple triangular “A” with a small cross‐bar */
    "M 306 360 "     /* bottom‐left of “A” */
    "L 396 140 "     /* top of “A” */
    "L 486 360 "     /* bottom‐right of “A” */
    "L 456 360 "     /* step back for cross‐bar anchor */
    "L 441 310 "     /* down for cross‐bar anchor */
    "L 361 310 "     /* over to opposite side of cross‐bar */
    "L 346 360 "     /* up to bottom portion */
    "L 306 360 "
    "Z "
    ...
    "M 440 140 "
    "C 533 140 573 180 573 220 "
    "C 573 260 533 280 467 280 "
    "C 400 280 360 300 360 340 "
    "C 360 380 400 360 467 360 "
    "C 533 360 573 340 573 300 "
    "L 533 300 "
    "C 533 320 507 340 467 340 "
    "C 427 340 400 320 360 300 "
    "C 360 280 427 260 467 260 "
    "C 533 260 573 240 573 200 "
    "C 573 160 533 140 440 140 "
    "Z",
